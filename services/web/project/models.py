...
class TV(Devices, FlaskSerializeMixin):
...
class Thermostat(Devices, FlaskSerializeMixin):
...
class Plug(Devices, FlaskSerializeMixin):
...
class Lights(Devices, FlaskSerializeMixin):
